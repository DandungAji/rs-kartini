...
//         {/* All Doctors */}
//         <div className="mt-16">
//           <AnimatedSection animationStyle="slide-up" delay={200}>
...
const Unavailable = () => {
  ...
  useEffect(() => {
    console.error(
      "503 Service Unavailable: Users cannot access the page yet.:",
      location.pathname
    );
  }, [location.pathname]);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="text-center">
        ...
        <p className="text-xl text-gray-600 mb-4">Maaf, halaman ini sedang dalam pemeliharaan untuk sementara waktu.</p>
